...
contract ERC721 {
    ...
    function approve(address spender, uint256 tokenId) external {
        ...
        require(msg.sender == owner || _isApprovedForAll[owner][msg.sender], "NOT_APPROVED");
    ...
    function transferFrom(
        ...
        require(
            msg.sender == owner || msg.sender == getApproved[tokenId] || _isApprovedForAll[owner][msg.sender],
            "NOT_APPROVED"
        );
    ...
    function permit(
        ...
        require(
            (recoveredAddress != address(0) && recoveredAddress == owner) || _isApprovedForAll[owner][recoveredAddress],
